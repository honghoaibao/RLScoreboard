...
/**
 * Owns every known board - the ones loaded from the scoreboards folder's YAML files plus
 * any "synthetic" boards published by other engines at runtime (currently: SIDEBAR-type
 * leaderboards, see [dev.rlscoreboard.leaderboard.renderer.SidebarLeaderboardRenderer]) -
 * and picks which one each player should currently see.
 */
class BoardManager(
