...
import dev.rlscoreboard.config.ConfigValidator
...
import dev.rlscoreboard.integration.geyser.GeyserIntegration
...
import dev.rlscoreboard.integration.worldedit.WorldEditIntegration
import dev.rlscoreboard.integration.worldguard.WorldGuardIntegration
...
class RLScoreboardPlugin : JavaPlugin() {
    ...
    override fun onEnable() {
        ...
        InternalPlaceholders.registerAll(placeholderEngine, integrationManager)
        ...
        // Design spec section 22: report config problems, never block startup over one.
        ConfigValidator.validateInstallation(dataFolder, logger)
