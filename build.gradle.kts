...
tasks.withType<KotlinCompile> {
    compilerOptions {
        // No -jvm-default flag: none of RLScoreboard's interfaces (RLScoreboardAPI,
        // BoardAPI, LeaderboardDataSource, etc.) declare default method bodies, so this
        // setting has nothing to affect here - and its accepted values differ between the
        // deprecated -Xjvm-default flag ("all", "all-compatibility", ...) and the current
        // -jvm-default flag ("enable", "no-compatibility", "disable"), which caused the
        // previous build failure. Simplest fix: don't set it.
    }
}
